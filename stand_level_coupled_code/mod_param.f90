module mod_param
  ...
  type, public :: universal_type
    ...
    ! Only for input to the SPAC-photosynthesis model
  ...
  type, public :: flux_type
    ...
    ! Flux variables
       ...
       real(8) :: sapmax                            ! Maximum water uptake rate (mol H2O/tree/s)
    ...
    real(8) :: sapmax_n                             ! Stand-level maximum DIN uptake rate (umol N/s/tree)
    real(8) :: sapmax_p                             ! Stand-level maximum DIP uptake rate (umol P/s/tree)
    ...
    real(8) :: gs                                   ! Stand-level stomatal conductance (mol H2O/m2/s)
