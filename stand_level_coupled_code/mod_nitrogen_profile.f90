...
contains
  ...
  subroutine nitrogen_profile ( &
    ...
    vcmax25top = vcmaxpft
!    jmax25top = 1.67d0 * vcmax25top       ! <= Bonan et al. (2014)
!    jmax25top = (2.56d0 - 0.0375d0*t_home - 0.0202d0*(t_growth - t_home)) * vcmax25top ! <= Kumarathunge et al. (2019)
    jmax25top = 1.54d0 * vcmax25top        ! <= Aspinwall et al. (2020)
!    rd25top = 0.015d0 * vcmax25top        ! <= Bonan et al. (2014)
